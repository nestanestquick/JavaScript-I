...
console.log(`The last car is a ${lastCar[49].car_year} ${lastCar[49].car_make} ${lastCar[49].car_model}` );



// ==== Challenge 3 ==== ----- car models pulled, need to figure out how to .sort correctly
